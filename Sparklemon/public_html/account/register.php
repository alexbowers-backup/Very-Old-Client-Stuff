    ...
    <fieldset>
        ...
        <ol>
            <li>
                ...
                <input type="text" name="f_name" tabindex="1" value="<?php echo $_GET['fname']; ?>" required placeholder="<?php echo $prefs_form_default['fname']; ?>" />
            </li><li>
                <label for="l_name">Last Name</label>
                <input type="text" name="l_name" tabindex="2" value="<?php echo $_GET['lname']; ?>" required placeholder="<?php echo $prefs_form_default['lname']; ?>" />
            </li><li>
