...
<head>
  ...
  <title>payment</title>
   <meta name="description" content="payment methods and detail on how you can pay " />
  <meta name="keywords" content="capoeria, servive, information, visa, mastercard, amex, cheque, cash, paypal  " />
...
<body>
    ...
    <div id="backgroundPopup"></div> 
       ...
       <div id="content" class="grid_9" >
			...
			<p>We are proudly accepts the following payment options:</p>
			<ol>
				<li>Visa</li>
				<li>Master Card</li>
				<li>American Express</li>
			</ol>
        <p>All credit card transactions are processed over a secure and encrypted i network to guard your payment information. We also accept international Visa and Master Cards! For your security, your billing name and address must match with  you credit card used for payment.</p>
