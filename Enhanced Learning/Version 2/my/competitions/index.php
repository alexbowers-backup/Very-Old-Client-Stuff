...
<title>My Current Competitions | <?=$config['system']['company_name'];?></title>
...
<script type="text/javascript">
  ...
  (function() {
	...
	.desc { margin: 5px 3px;float:left }
	.info {
        float: left;
        width: 70px;
        margin-right: 65px;
	...
	.desc .long{ width: 175px; }
	.box{ float:left;  width:700px; 	}
