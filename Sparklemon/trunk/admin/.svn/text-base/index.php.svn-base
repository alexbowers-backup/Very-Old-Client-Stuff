...
$query=mysql_query("SELECT id FROM user_payments WHERE complete='0'");
if (!$query) {
	echo "MySQL Error: ".mysql_error();
}
$num_request=mysql_num_rows($query);
?>
...
<ul>
	...
	<li><a href="payment_requests.php">Payment Requests (<?php echo $num_request; ?>)</a></li>
