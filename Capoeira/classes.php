...
<body>
  ...
  <li><a href="capoeira_moves.php" target="_top">Capoeira Moves</a></li>
       ...
       <div id="content" class="grid_9" >
          ...
          <div id="slider">
				<img src="img/bannerkidsclasses.gif" alt="" />
			 </div>
         	<ul>
					<li>From 5 to 16 years old.</li> 
         	...
         	<p>While there many extra-curricular activities available for kids today Capoeira has the potential to offer an incredible range of experience. Our classes teach not only the martial art and game of capoeira but also the music, language, and culture. The setting i fun and Master Carlos uses an approach that is best desbribes as fun within structure and learning. Some of things your child will learn:</p>
         	
         	<ol>
					<li>Basic movements of Capoeira including kicks, blocks, ginga,    
        cartwheels, and handstands.</li>
        			<li>Play the Pandeiro (Tambourine), Atabaque(Drum), Clap and sing.</li>
        			<li>Basic Portuguese language</li>
        			<li>Respesct for other cultures and other people</li>
        			<li>The joy of working to achieve goals</li>   	
         	</ol>
       </div> <!--! end of #content -->
