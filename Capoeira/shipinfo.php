...
<head>
  ...
  <meta name="description" content="shipping details and information, and the methods of packaging also " />
  <meta name="keywords" content="capoeria, servive, information, shipping methods  " />
    ...
    <div id="backgroundPopup"></div> 
       ...
       <div id="content" class="grid_9" >
			...
			<h3>SHIPPING INFORMATION</h3>
				...
				<p>Purchased and shipping destination. Each shipping   Different shipping methods will be available depending on the product(s)method has its own
restrictions and charges that will be applied to your order. At ckeckout, you will be prompted to choose a shipping method for your product(s).
Please note that some items may offer only one shipping method.
</p>
			<h4>Shipping insurance is optional upon customer request.</h4>
