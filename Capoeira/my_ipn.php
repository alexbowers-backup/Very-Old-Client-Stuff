...
$sql = mysql_query("SELECT id FROM orders WHERE transaction)id_id='$this_txn' LIMIT 1");
...
foreach ($id_str_array as $key => $value) {
	...
	$sql = mysql_query("SELECT price FROM store WHERE id_products='$product_id' LIMIT 1");
