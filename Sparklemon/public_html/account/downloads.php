...
?>
<h1>Downloads</h1>
<p>Download your purchased files below.  Please keep in mind that due to bandwith costs you can only download a file again 5 times.  If you need, you can buy 5 more downloads for $1.00 credit.</p>
<table class="normal">
	<tr>
		<th scope="col">File</th>
		<th scope="col">Downloads Left</th>
		<th scope="col">Buy 5 Downloads ($1.00 Credit)</th>
	...
	while ($row=mysql_fetch_array($query))
	{
		...
		<tr class="file_row">
			...
			<td><a href="../process/dl_buy.php?id='.$file_id.'">Purchase 5 Downloads</a></td>
