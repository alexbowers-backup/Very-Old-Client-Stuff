...
if (!$resp->is_valid) {
	header("Location: ../account/login.php?error=1".$back_url);
	exit;
}
/* END ERRORS */
...
<p>You have requested a confirmation link. Please click on the following link to confirm your account.</p>
