...
<title>Current PHP Competitions | <?=$config['system']['company_name'];?></title>
...
<div id="container">
    ...
    <div id="wrapper">
        ...
        <hgroup class="one">
            	<h2 class="main_title">Current PHP Competitions</h2>
                <h3 class="subtitle">This lists all current PHP competitions.</h3>
            </hgroup>
			<div class="one">
            ...
            <div class="one_half">
                ...
                <p>Cost of entry: free</p>
                <p>Marker: Alex Bowers</p>
                <p>Estimated time to complete: 3 hours</p>
                <p>Prize: $50.00 / Glory</p>
                <p>Current Entrants: 12</p>
                <p><small>Click below to view the cover story.</small></p>
                <button class="large square button black">See More</button>
            </div>
            <div class="one_half">
            	<h3>Competition Name</h3>
                <p>Cost of entry: free</p>
