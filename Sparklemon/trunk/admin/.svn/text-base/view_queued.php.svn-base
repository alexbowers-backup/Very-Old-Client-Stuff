...
<h1 style="margin-bottom: 0;"><?php echo $i_name; ?> <span style="font-size: 15pt; margin-left: 2px; vertical-align: 1px"> by <a href="<?php echo $prefs_sitebase; ?>/user/<?php echo $i_seller; ?>"><?php echo $i_seller_name; ?></a></span></h1>

<form>
<fieldset><ol>
<label>Author's Email</label>
<a href="mailto:<?php echo $i_seller_email; ?>"><?php echo $i_seller_email; ?></a>
	<h2>Files</h2>
	<li>
	...
	<li>
		...
		?> <?php if ($show_subtype != '') : ?><span id="arrow"><img src="<?php echo $prefs_sitebase; ?>/images/dropdown_arrow.png" style="vertical-align: middle;" alt="--&gt;" /></span> <?php endif; echo $show_subtype; ?>
	</li>
	</ol></fieldset>
<input type="submit" class="green-btn" value="Approve" /><input type="button" class="red-btn" value="Reject" />
</form>
