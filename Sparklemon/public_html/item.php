...
<p><?php echo $i_description; ?></p></div>
<div class="sidebar">
    <div class="user">
        <!--<img class="gravatar" src="<?php echo $prefs_sitebase; ?>/images/avatars/<?php echo user_get_avatar($i_seller);  ?>" />-->
        <h1 class="inline username"><a href="<?php echo $prefs_sitebase; ?>/user.php?id=<?php echo $i_seller; ?>"><?php echo user_get_name_only($i_seller); ?></a></h1>
        <img class="gravatar" src="<?php echo $prefs_sitebase; ?>/images/avatars/<?php echo user_get_avatar($i_seller);  ?>" />
