...
<head>
  ...
  <title>contact-cs</title>
  <meta name="description" content="customer service will give all information that we provide and also we will provide any help that you requare " />
...
<body>
    ...
    <div id="backgroundPopup"></div> 
       ...
       <div id="content" class="grid_9" >
			...
			<h3>NEED HELP?</h3>
      		<p>We are here to try to solve any problem that your may face with buy or
  booking classes.</p>
  			<h4>Frequently ask questions</h4>
  			
  			<ol>
  				<li><a href="" >When will my product be delivered?</a></li>
  				<li><a href="" >What if some of the product be missing or danger?</a></li>
  				<li><a href="" >I'm afraid to string my berimbau because it appers to be cracked. Can I
   exchange it?</a></li>
   			<li><a href="" >What do I do if I receive the wrong size, or color of a product?</a></li>
   			<li><a href="" >How can I return an item?</a></li>
   			<li><a href="" >What if I need to cancel an order?</a></li>
  			</ol>
